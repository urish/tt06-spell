# Spell "SPELL" on a 7-segment display connected to the uio port of the Tiny Tapeout Demo board
# Works with the Simon Says Pmod: https://github.com/urish/tt-simon-pmod
#
...
def run():
    ...
    # fmt: off
    test_program = [
       127, 55, 119, 0, 129, 57, 57, 244, 62, 116, 109, 56, 119, 250, 
       44, 0, 56, 119, 25, 44, 11, 64, 3, 61
    ]
    # fmt: on
